...
<div class="container col-xs-12 detail_wrapper zoomIn wow animated">

	<a  class="exitbtn right" href="/shop"><img src="<?php echo get_template_directory_uri(); ?>/images/close.png" width="20px"></a>

	<div class="detail_header">
		<a href="/shop"> Shop </a>
		<a href="/<?php the_title(); ?>"><?php wp_title(); ?></a>
	</div>
